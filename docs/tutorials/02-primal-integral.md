---
layout: default
title: "2 · Measuring "good solutions early""
---
...
1 % for each. Code: [`src/optopt/analysis/metrics.py`](https://github.com/berkorbay/optopt/blob/main/src/optopt/analysis/metrics.py) (and its tests in `tests/`).
